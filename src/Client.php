...
include_once base_path() . '/vendor/imagekit/imagekit/src/ImageKit/Constants/endpoint.php';
include_once base_path() . '/vendor/imagekit/imagekit/src/ImageKit/Utils/transformation.php';
include_once base_path() . '/vendor/imagekit/imagekit/src/ImageKit/Utils/authorization.php';
...
class Client
{
    ...
    public function uploadFiles($options)
    {
        ...
        $client = new \GuzzleHttp\Client(addAuthorization(['verify' => false], $defaultOptions));
